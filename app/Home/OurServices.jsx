...
const OurServices = () => {
    return (
        <div>
            <div className="grid lg:grid-cols-5 lg:gap-0 gap-10 lg:mt-0 mt-10 justify-around bg-white lg:shadow-md rounded-lg lg:p-10 lg:w-10/12 w-7/12 border px-4 py-8 mx-auto">
